...
slug: "sailor-speak"
accentColor: "#1E90FF"
nativeSpeakers: ["wrofast"]
currentSpeakers: ["wrofast", "sea-traders", "maritime-communities"]
status: "Active (maritime creole — no formal written form)"
usedIn: ["wrofast", "glaril", "neruvalis", "ipadora-sanctuary"]
script: "None — transmitted through immersion and use only"
parentLanguages: ["common", "sylvaren"]
relatedCharacters: []
